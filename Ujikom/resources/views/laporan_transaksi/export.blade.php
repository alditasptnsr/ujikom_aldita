...
<script>
    function createPDF() {
        ...
        win.document.write('<title> HYUNGDRY - Laundry <?= date('F Y') ?></title>');   // <title> FOR PDF HEADER.
        win.document.write(style);          // ADD STYLE INSIDE THE HEAD TAG.
        win.document.write('</head>');
        win.document.write('<body>');
        win.document.write('<h1 class="title title-1 m-0 p-0"">Hyungdry Laundry</h1>');
        ...
        win.document.write('<h3 class="title mb-2">LAPORAN TRANSAKSI HYUNGDRY-LAUNDRY</h3> <br>');
